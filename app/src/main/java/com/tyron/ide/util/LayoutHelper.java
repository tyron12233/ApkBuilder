...
public class LayoutHelper {
    ...
    public static CardView.LayoutParams createCard(int width, int height) {
        return new CardView.LayoutParams(getSize(width), getSize(height));
    }

    public static CardView.LayoutParams createCard(int width, int height, int gravity) {
        return new CardView.LayoutParams(getSize(width), getSize(height), gravity);
    }

    public static CardView.LayoutParams createCard(int width, float height, int gravity,
                                                   float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        CardView.LayoutParams layoutParams = new CardView.LayoutParams(getSize(width),
                getSize(height), gravity);
        layoutParams.setMargins(AndroidUtilities.dp(leftMargin), AndroidUtilities.dp(topMargin),
                AndroidUtilities.dp(rightMargin), AndroidUtilities.dp(bottomMargin));
        return layoutParams;
